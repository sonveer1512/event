  ...
  <?php include 'includes/header.php'; ?>
    ...
    <!-- Page content -->
				<div class="container-fluid">
					...
					<input type="Event Name" class="form-control" id="pname" placeholder="Enter Event Name" name="name" value="<?php echo $prodata['p_name'] ?>">
						</div>
						<div class="form-group">
						 <label for="Event Name"> Promotion Url</label>
					<input type="Event Name" class="form-control" id="purl" placeholder="Enter url" name="name" value="<?php echo $prodata['p_url']; ?>">
						</div>
						<div class="form-group">
						 <label for="Event Name"> Promotion image</label>
					<input type="file" class="form-control" id="pimage" placeholder="Enter Event Name" name="name">
						</div>						
						
						<?php
							if($pro_type){
								?>
								<button id="psubmit" class="btn btn-primary">Submit</button>
								<?php
							}else{
								?>
